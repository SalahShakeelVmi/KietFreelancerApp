                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink href={route('users.index')} active={route().current('users.index') || route().current('users.search')}>
                                    Users
                                </NavLink>

                                <NavLink href={route('project-categories.index')} active={route().current('project-categories.index') || route().current('project-categories.search')}>
                                    Project Categories
                                </NavLink>
